...
for i in range(3):
    ...
    button2 = driver2.find_element(By.CSS_SELECTOR, ".btn-primary")
    button2.send_keys(Keys.RETURN)

for i in range(3):
    driver1 = webdriver.Chrome(service=ChromeService(
        ChromeDriverManager().install()))
    driver1.get("http://uitestingplayground.com/classattr")
    driver1.implicitly_wait(100)  # Когда страница самостоятельно не прогружается
    button1 = driver1.find_element(By.CSS_SELECTOR, ".btn-primary")
